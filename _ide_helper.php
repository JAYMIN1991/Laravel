 ...
 * Generated for Laravel 5.3.28 on 2017-05-16.
 *
...
namespace {
    ...
    class Widget extends \Flinnt\Core\View\Widgets\Facade{
        ...
        public static function run(){
            return \Flinnt\Core\View\Widgets\Factories\WidgetFactory::run();
        }
        ...
        public static function encryptWidgetParams($params){
            //Method inherited from \Flinnt\Core\View\Widgets\Factories\AbstractWidgetFactory            
            return \Flinnt\Core\View\Widgets\Factories\WidgetFactory::encryptWidgetParams($params);
        }
        ...
        public static function decryptWidgetParams($params){
            //Method inherited from \Flinnt\Core\View\Widgets\Factories\AbstractWidgetFactory            
            return \Flinnt\Core\View\Widgets\Factories\WidgetFactory::decryptWidgetParams($params);
        }
        
    }


    class AsyncWidget extends \Flinnt\Core\View\Widgets\AsyncFacade{
         ...
         */
        public static function run(){
            return \Flinnt\Core\View\Widgets\Factories\AsyncWidgetFactory::run();
        }
        ...
        public static function encryptWidgetParams($params){
            //Method inherited from \Flinnt\Core\View\Widgets\Factories\AbstractWidgetFactory            
            return \Flinnt\Core\View\Widgets\Factories\AsyncWidgetFactory::encryptWidgetParams($params);
        }
        ...
        public static function decryptWidgetParams($params){
            //Method inherited from \Flinnt\Core\View\Widgets\Factories\AbstractWidgetFactory            
            return \Flinnt\Core\View\Widgets\Factories\AsyncWidgetFactory::decryptWidgetParams($params);
        }
        
    }


    class Firewall extends \Flinnt\BackOffice\Firewall\Facades\Firewall{
        
    }


    class SMS extends \Flinnt\Core\SMS\Facades\SMS{
        
        /**
         * Instantly send the message.
         *
         * @param \Flinnt\Core\SMS\SMSNotifiableContract|String $content
         * @param null|string $to
         * @return mixed 
         * @static 
         */
        public static function send($content, $to = null){
            return \Flinnt\Core\SMS\SMSHandler::send($content, $to);
        }
        ...
        public static function queue($content){
            return \Flinnt\Core\SMS\SMSHandler::queue($content);
        }
         ...
         * @static 
         */
        public static function later($delay, $content){
            return \Flinnt\Core\SMS\SMSHandler::later($delay, $content);
        }
         ...
         *
         * @param string $to
         * @return \Flinnt\Core\SMS\SMSHandlerBridge 
         * @static 
         */
        public static function to($to){
            return \Flinnt\Core\SMS\SMSHandler::to($to);
        }
         ...
         * @static 
         */
        public static function toArray($to){
            return \Flinnt\Core\SMS\SMSHandler::toArray($to);
        }
         ...
         */
        public static function setQueue($queue){
            return \Flinnt\Core\SMS\SMSHandler::setQueue($queue);
        }
        ...
        public static function getGateway(){
            return \Flinnt\Core\SMS\SMSHandler::getGateway();
        }
        
    }


    class DBLog extends \Flinnt\Core\DBLog\Facade\DBLog{
         ...
         */
        public static function getInstance(){
            return \Flinnt\Core\DBLog\DBLog::getInstance();
        }
         ...
         * @static 
         */
        public static function save($module, $moduleId, $action, $uri, $userId, $info = null){
            return \Flinnt\Core\DBLog\DBLog::save($module, $moduleId, $action, $uri, $userId, $info);
        }
        
    }


    class LaxusMail extends \Flinnt\Core\Mail\Facades\LaxusMailFacade{
    ...
    class LaxusSMS extends \Flinnt\Core\SMS\Facades\LaxusSMS{
    ...
    class CacheManager extends \Flinnt\Core\Cache\Facades\CacheManager{
         ...
         * @static 
         */
        public static function view($view, $key, $time = null, $tags = null){
            return \Flinnt\Core\Cache\CacheManager::view($view, $key, $time, $tags);
        }
         ...
         * @static 
         */
        public static function getView($key, $tags = null){
            return \Flinnt\Core\Cache\CacheManager::getView($key, $tags);
        }
         ...
         * @static 
         */
        public static function forgetView($key, $tags = null){
            return \Flinnt\Core\Cache\CacheManager::forgetView($key, $tags);
        }
         ...
         * @static 
         */
        public static function rawData($data, $key, $time = null, $tags = null){
            return \Flinnt\Core\Cache\CacheManager::rawData($data, $key, $time, $tags);
        }
         ...
         * @static 
         */
        public static function getRawData($key, $tags = null){
            return \Flinnt\Core\Cache\CacheManager::getRawData($key, $tags);
        }
         ...
         * @static 
         */
        public static function forgetRawData($key, $tags = null){
            return \Flinnt\Core\Cache\CacheManager::forgetRawData($key, $tags);
        }
         ...
         * @static 
         */
        public static function query($query, $bindings = array(), $time = null, $tags = null){
            return \Flinnt\Core\Cache\CacheManager::query($query, $bindings, $time, $tags);
        }
         ...
         * @static 
         */
        public static function getQuery($query, $bindings = array(), $tags = null){
            return \Flinnt\Core\Cache\CacheManager::getQuery($query, $bindings, $tags);
        }
         ...
         * @static 
         */
        public static function forgetQuery($query, $bindings = array(), $tags = null){
            return \Flinnt\Core\Cache\CacheManager::forgetQuery($query, $bindings, $tags);
        }
        ...
        public static function flush($tags){
            \Flinnt\Core\Cache\CacheManager::flush($tags);
        }
        
    }


    class Helper extends \Flinnt\BackOffice\Support\Facades\Helpers{
         ...
         * @static 
         */
        public static function dateToTimestamp($date = null, $format = 'input_date_format'){
            return \Flinnt\BackOffice\Support\Helpers::dateToTimestamp($date, $format);
        }
         ...
         * @static 
         */
        public static function datetimeToTimestamp($datetime = null, $format = 'input_date_time_format'){
            return \Flinnt\BackOffice\Support\Helpers::datetimeToTimestamp($datetime, $format);
        }
         ...
         * @return \Flinnt\BackOffice\Support\Carbon 
         * @static 
         */
        public static function timestempToDate($timestemp = null, $format = 'output_date_format'){
            return \Flinnt\BackOffice\Support\Helpers::timestempToDate($timestemp, $format);
        }
         ...
         * @static 
         */
        public static function timestempToDatetime($timestemp = null, $format = 'output_date_time_format'){
            return \Flinnt\BackOffice\Support\Helpers::timestempToDatetime($timestemp, $format);
        }
         ...
         * @static 
         */
        public static function isLoginUserAnAdmin(){
            return \Flinnt\BackOffice\Support\Helpers::isLoginUserAnAdmin();
        }
         ...
         * @static 
         */
        public static function getIPAddress($singleIp = false){
            return \Flinnt\BackOffice\Support\Helpers::getIPAddress($singleIp);
        }
         ...
         * @static 
         */
        public static function getDate($outputDateFormat = 'mysql_date_format', $date = 'now', $inputDateFormat = 'input_date_format'){
            return \Flinnt\BackOffice\Support\Helpers::getDate($outputDateFormat, $date, $inputDateFormat);
        }
